...
<template>
  <div class="xl:my-[80px] font-heading-pro">
    ...
    <ShowcaseSection>
      ...
      <template #content>
        <ShowcaseParagraph>
          My Basic-Fit is a React-based app that serves as a self-help dashboard system that members
          can use to make changes to their accounts. The platform's main intention is to remove
          workload from customer service (changing membership, buying add-ons, etc.). On top of
          that, it also contains some premium features like inviting a friend.
        </ShowcaseParagraph>
      </template>
    </ShowcaseSection>
    <ShowcaseBlock class="border-mint bg-gray-light relative">
      ...
      <template #content>
        <ShowcaseParagraph>
          During my time at Basic-Fit, new branding style guides were introduced. That implied that
          My Basic-Fit needed to get a new layout. Together with two other team members, we set out
          to make this happen
        </ShowcaseParagraph>
        <ShowcaseImage>
          <NuxtPicture
      ...
      <template #content>
        ...
        <ShowcaseParagraph>
          ...
          <template #content>
            ...
            static files. We implemented I18Next and configured it to use static files and a caching
            mechanism using the session storage.
          </template>
        </ShowcaseParagraph>
        <ShowcaseImage>
          <NuxtPicture
    ...
    <ShowcaseSection>
      ...
      <template #content>
        <ShowcaseParagraph>
          To prevent changes from breaking the codebase, we wrote tests. Unit tests allow us to make
          sure that complex logic always gives the expected outcome. E2E tests help us makes sure
          that all web pages and user flows work as intended.
          <br />
          <br />
    ...
    <ShowcaseFooter class="bg-gray-light">
      ...
      <template #content>
        <ShowcaseParagraph>
          ...
          <br />
          <br />
          With New Relic, we can see all traffic, errors, and browser details. That helps us to find
