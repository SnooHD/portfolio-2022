  ...
  <div class="font-manrope xl:py-[80px]">
    <div
      :class="`
        ...
        ${isImageLoaded('header-bg') ? 'opacity-100' : 'opacity-0'}  
      `"
    >
      <ShowcaseHeader>
        <template #background>
      ...
      <ShowcaseSection class="mb-[100px]">
        ...
        <template #content>
          <ShowcaseParagraph>
            ...
            <template #content>
              SVG paths are just code, so we can easily store them in any database. However, they
              can be really long, and take quite a lot of space. The best course of action would be
              ...
              <br />
              This setup allows us to save custom user made logo’s by just storing the path
              reference ids, and the specific customizations the user made. E.g. colors and shape
              position.
            </template>
          </ShowcaseParagraph>
          <ShowcaseParagraph>
            ...
            <template #content>
              ...
              source) and is a lot more performant. But it doesn’t come without its flaws: It is
              more complex to use, not all SVG features work out of the box in canvas (e.g. text
              path), and importing or exporting an SVG will need custom logic.
              <br />
              <br />
              <b>Konva.js</b>
              <br />
              Meet Konva, it doesn’t solve the text path issue fully (not working with custom
              fonts), but it does come with a lot of useful tools. We get transform tools, can
              easily import SVGs (exporting still needs custom logic), and much more.
              <br />
              <br />
              <b>CSS Transforms</b>
              <br />
              When you apply transform: scale(.8) translateX(20%) it scales to 0.8, and from those
              new dimensions, it will translate 20%. This is not how Konva works. Konva objects
              allow one transform property, and the transforms are always calculated on the initial
              dimensions. To tackle this I build some logic that can transpile chained CSS into the
